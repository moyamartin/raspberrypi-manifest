Custom Raspberry Repo Manifests for the Yocto Project Build System
=============================================
This repository provides Repo manifests to setup the Yocto build system for 
supported RaspberryPi boards.

The Yocto Project allows the creation of custom linux distributions for embedded
systems, including Raspberry Pis.  It is a collection of git
...
Tell Repo where to find the manifest:
    ...
    $ repo init -u https://github.com/moyamartin/raspberrypi-manifest.git -b <branch>
...
Clone this repository (or fork it on github):
    ...
    $ git clone git://github.com/moyamartin/raspberrypi-manifest/yocto-manifest.git
